...
namespace Telebot
{
    ...
    void from_json(const Json& json, Message& object)
    {
        ...
        VECTOR_FROM_JSON(new_chat_members)
        OBJECT_FROM_JSON(left_chat_member)
        VALUE_FROM_JSON(new_chat_title)
        VECTOR_FROM_JSON(new_chat_photo)
